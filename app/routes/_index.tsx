  ...
  return (
    <div className="bg-white h-full">
      <div className="max-w-screen-xl flex flex-col flex-wrap items-center justify-between mx-auto p-4">
        <h1 className="mt-16 self-center text-2xl font-semibold whitespace-nowrap">Survey Demo</h1>
        <div className="w-full mt-8 md:block md:w-auto">
          <ul className="font-medium justify-center flex-col flex p-4 md:p-0 mt-4 border gap-4 border-gray-100 md:mt-0 md:border-0">
            <li>
              <NavLink to="/survey/join" className="block py-4 px-6 bg-sapphire-700 text-white text-primary underline-offset-4 hover:underline text-center">Join Survey</NavLink>
            </li>
            <li>
              <NavLink to="/survey/results" className="block py-4 px-6 bg-sapphire-700 text-white text-primary underline-offset-4 hover:underline text-center">View Results</NavLink>
            </li>
          </ul>
        </div>
      </div>
